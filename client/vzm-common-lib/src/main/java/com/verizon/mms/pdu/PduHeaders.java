...
public class PduHeaders {
    ...
    public static final int MESSAGE_TYPE_SEND_REQ_X           = 0x7D;
    public static final int MESSAGE_TYPE_SEND_CONF          = 0x81;
    public static final int MESSAGE_TYPE_NOTIFICATION_IND   = 0x82;
    public static final int MESSAGE_TYPE_NOTIFICATION_IND_X   = 0x7F;
    ...
    public static final int MESSAGE_TYPE_READ_REC_IND_X       = 0x7E;
    ...
    public void setOctet(int value, int field)
        ...
        switch (field) {
            ...
            case MMS_VERSION:
                ...
                break;
            case MESSAGE_TYPE:
//            	if (value == MESSAGE_TYPE_NOTIFICATION_IND) {
//            		value = MESSAGE_TYPE_NOTIFICATION_IND_X;
//            	}
//            	if (value == MESSAGE_TYPE_READ_REC_IND) {
//            		value = MESSAGE_TYPE_READ_REC_IND_X;
//            	}
//                if ((value < MESSAGE_TYPE_SEND_REQ) || (value > MESSAGE_TYPE_CANCEL_CONF)) {
                if ((value < MESSAGE_TYPE_SEND_REQ_X) || (value > MESSAGE_TYPE_CANCEL_CONF)) {
                    // Invalid value.
                    throw new InvalidHeaderValueException("Invalid Octet value!");
                }
                break;
    ...
    protected void fixNotificationMessageType() throws InvalidHeaderValueException {
    	Integer octet = (Integer) mHeaderMap.get(MESSAGE_TYPE);
        if (null == octet) {
        	return;
        }
        if (MESSAGE_TYPE_NOTIFICATION_IND == octet) {
            mHeaderMap.put(MESSAGE_TYPE, MESSAGE_TYPE_NOTIFICATION_IND_X);        	  
        } else if (MESSAGE_TYPE_READ_REC_IND == octet) {
            mHeaderMap.put(MESSAGE_TYPE, MESSAGE_TYPE_READ_REC_IND_X);        	          	  
        } else {
        	Logger.error(getClass(), "FixNotificationMessageType called with unexpected type:" + octet);
        }
    }
    ...
    public String toString() {
    	...
    	String delim = ": ";
    	final HashMap<Integer, Object> map = mHeaderMap;
    	for (int field : map.keySet()) {
        	sb.append(delim);
        	delim = ", ";
    		sb.append(Integer.toHexString(field));
    		sb.append(" = ");
