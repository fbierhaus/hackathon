...
public class EncodedStringValue implements Cloneable {
    ...
    public EncodedStringValue(String data) {
        try {
        	...
        	Logger.error(getClass(), "Default encoding must be supported.", e);
        }
    }
        ...
        if (CharacterSets.ANY_CHARSET == mCharacterSet) {
            ...
            try {
                ...
                if (Logger.IS_DEBUG_ENABLED) {
            		Logger.warn(getClass(), "getString: unsupported character set " + mCharacterSet);
            	}
            	try {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        try {
        	...
        	Logger.error(getClass(), "failed to clone an EncodedStringValue: " + this);
        	Logger.error(e);
...
// No Reference found     
     ...
     */
//    public static String concat(Context context, EncodedStringValue[] addr, boolean contactNames) {
//        StringBuilder sb = new StringBuilder();
//        int maxIndex = addr.length - 1;
//        for (int i = 0; i <= maxIndex; i++) {
//        	String val = addr[i].getString();
//        	if (contactNames) {
//				if (MessageUtils.isLocalNumber(val)) {
//					val = context.getString(R.string.me);
//				}
//				else {
//					val = Contact.get(val, true, true).getName();
//				}
//        	}
//            sb.append(val);
//            if (i < maxIndex) {
