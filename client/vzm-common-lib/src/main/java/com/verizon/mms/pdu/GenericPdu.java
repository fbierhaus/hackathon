...
public class GenericPdu {
     ...
     *         RuntimeException if field's value is not Octet.
     */
    public void fixNotificationMessageType() throws InvalidHeaderValueException {
        mPduHeaders.fixNotificationMessageType();
    }
     ...
     *
     * @param header the constant value of the header
     * @return the header value
     */
    public EncodedStringValue[] getHeader(int header) {
        return mPduHeaders.getEncodedStringValues(header);
    }
