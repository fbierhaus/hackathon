 ...
 * in the system. You can use {@link android.os.SystemProperties os.SystemProperties} to get and set these values.
 * 
 * @hide
 */
public interface TelephonyProperties {
	...
	// ****** SIM Card
	/**
	 * One of <code>"UNKNOWN"</code> <code>"ABSENT"</code> <code>"PIN_REQUIRED"</code> <code>"PUK_REQUIRED"</code>
	...
	/**
	 * Indicates the available radio technology. Values include: <code>"unknown"</code>, <code>"GPRS"</code>,
	 * <code>"EDGE"</code> and <code>"UMTS"</code>.
	 */
