...
public class TelephonyIntents {
	 ...
	 * {@link android.telephony.ServiceState#STATE_EMERGENCY_ONLY} or
	 * {@link android.telephony.ServiceState#STATE_POWER_OFF}
	 ...
	 * <li><em>operator-alpha-short</em> - A potentially shortened version of the carrier name, as a string.</li>
	 * <li><em>operator-numeric</em> - A number representing the carrier, as a string. This is a five or six digit
	 * number consisting of the MCC (Mobile Country Code, 3 digits) and MNC (Mobile Network code, 2-3 digits).</li>
	 * <li><em>manual</em> - A boolean, where true indicates that the user has chosen to select the network manually,
	 * and false indicates that network selection is handled by the phone.</li>
	 * </ul>
	 * 
	 * <p class="note">
	 ...
	 * 
	 * <p class="note">
	 * You can <em>not</em> receive this through components declared in manifests, only by explicitly registering for it
	 * with
	 * {@link android.content.Context#registerReceiver(android.content.BroadcastReceiver, android.content.IntentFilter)
	 ...
	 * <li><em>asu</em> - A numeric value for the signal strength. An ASU is 0-31 or -1 if unknown (for GSM, dBm = -113
	 * - 2 * asu). The following special values are defined:
	 * <ul>
	 * <li>0 means "-113 dBm or less".</li>
	 * <li>31 means "-51 dBm or greater".</li>
	 * </ul>
	 * </li>
	 * </ul>
	 * 
	 * <p class="note">
	 * You can <em>not</em> receive this through components declared in manifests, only by exlicitly registering for it
	 * with
	 * {@link android.content.Context#registerReceiver(android.content.BroadcastReceiver, android.content.IntentFilter)
	 * Context.registerReceiver()}.
	 * 
	 ...
	 * <ul>
	 * <li><em>phoneName</em> - A string version of the phone name.</li>
	 * <li><em>state</em> - One of <code>"CONNECTED"</code> <code>"CONNECTING"</code> or <code>"DISCONNNECTED"</code></li>
	 * <li><em>apn</em> - A string that is the APN associated with this connection.</li>
	 * <li><em>apnType</em> - A string array of APN types associated with this connection. The APN type <code>"*"</code>
	 * is a special type that means this APN services all types.</li>
	 * </ul>
	 * 
	 * <p class="note">
	 * Requires the READ_PHONE_STATE permission.
	 ...
	 * <li><em>state</em> &mdash; One of <code>"CONNECTED"</code> <code>"CONNECTING"</code> or
	 * <code>"DISCONNNECTED"</code></li>
	 ...
	 * <ul>
	 * <li><em>phoneName</em> - A string version of the phone name.</li>
	 * <li><em>ss</em> - The sim state. One of <code>"ABSENT"</code> <code>"LOCKED"</code> <code>"READY"</code>
	 * <code>"ISMI"</code> <code>"LOADED"</code></li>
	 * <li><em>reason</em> - The reason while ss is LOCKED, otherwise is null <code>"PIN"</code> locked on PIN1
	 * <code>"PUK"</code> locked on PUK1 <code>"NETWORK"</code> locked on Network Personalization</li>
	 * </ul>
	 * 
	 * <p class="note">
	 * Requires the READ_PHONE_STATE permission.
	 ...
	 * <p class="note">
	 * . This is to pop up a notice to show user that the phone is in emergency callback mode and atacalls and outgoing
	 * sms are blocked.
	 * 
	 * <p class="note">
	 * This is a protected intent that can only be sent by the system.
