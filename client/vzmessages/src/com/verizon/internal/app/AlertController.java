...
package com.verizon.internal.app;
...
public class AlertController {
	 ...
	 * 
	 * @param whichButton
	 *            Which button, can be one of {@link DialogInterface#BUTTON_POSITIVE},
	...
	private void setupView() {
		...
		if (mView != null) {
			...
			FrameLayout custom = (FrameLayout) mWindow.findViewById(1);// R.id.custom);
