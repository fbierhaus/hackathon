...
import com.verizon.vcard.android.syncml.pim.VBuilder;
...
//    public static final String DEFAULT_CHARSET = VParser.DEFAULT_CHARSET;
    ...
    protected boolean isValidPropertyName(String propertyName) {
        if (!(sAvailablePropertyNameV21.contains(propertyName.toUpperCase()) ||
            ...
            Logger.warn(getClass(), "Property name unsupported by vCard 2.1: " + propertyName);
        }
        return true;
    }
    ...
    protected void handleType(String ptypeval) {
        ...
        if (!(sKnownTypeSet.contains(upperTypeValue) || upperTypeValue.startsWith("X-")) && 
            ...
            Logger.warn(getClass(), "Type unsupported by vCard 2.1: " + ptypeval);
        }
        if (mBuilder != null) {
    ...
    protected void handlePropertyValue(
        ...
        if (mEncoding.equalsIgnoreCase("QUOTED-PRINTABLE")) {
            ...
            try {
                ...
                Logger.error(getClass(), "OutOfMemoryError happened during parsing BASE64 data!");
                if (mBuilder != null) {
            ...
            if (!(mEncoding == null || mEncoding.equalsIgnoreCase("7BIT")
                ...
                Logger.warn(getClass(), "The encoding unsupported by vCard spec: \"" + mEncoding + "\".");
            }
    ...
    public void showDebugInfo() {
        Logger.debug(getClass(), "total parsing time:  " + mTimeTotal + " ms");
        if (mReader instanceof CustomBufferedReader) {
            if (Logger.IS_DEBUG_ENABLED) {
                Logger.debug(getClass(),
                        "total readLine time: " + ((CustomBufferedReader) mReader).getTotalmillisecond()
                                + " ms");
            }
        }
        if (Logger.IS_DEBUG_ENABLED) {
            Logger.debug(getClass(), "mTimeStartRecord: " + mTimeStartRecord + " ms");
            Logger.debug(getClass(), "mTimeEndRecord: " + mTimeEndRecord + " ms");
            Logger.debug(getClass(), "mTimeParseItem1: " + mTimeParseItem1 + " ms");
            Logger.debug(getClass(), "mTimeParseItem2: " + mTimeParseItem2 + " ms");
            Logger.debug(getClass(), "mTimeParseItem3: " + mTimeParseItem3 + " ms");
            Logger.debug(getClass(), "mTimeHandlePropertyValue1: " + mTimeHandlePropertyValue1 + " ms");
            Logger.debug(getClass(), "mTimeHandlePropertyValue2: " + mTimeHandlePropertyValue2 + " ms");
            Logger.debug(getClass(), "mTimeHandlePropertyValue3: " + mTimeHandlePropertyValue3 + " ms");
        }
    }
