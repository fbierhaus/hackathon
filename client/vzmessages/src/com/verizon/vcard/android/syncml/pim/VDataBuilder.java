...
package com.verizon.vcard.android.syncml.pim;
...
import com.verizon.vcard.android.content.ContentValues;
...
//            mSourceCharset = VParser.DEFAULT_CHARSET;
    ...
    private String encodeString(String originalString, String targetCharset) {
        ...
        try {
            ...
            Logger.error(getClass(), "Failed to encode: charset=" + targetCharset);
        ...
        if (encoding != null) {
            if (encoding.equals("BASE64") || encoding.equals("B")) {
                ...
                try {
                    ...
                    Logger.error(getClass(), "Failed to encode: charset=" + mSourceCharset);
                ...
                try {
                    ...
                    Logger.error(getClass(), "Failed to decode quoted-printable: " + e);
                    return "";
                }
