 ...
 */
public class SlideshowEditActivity extends VZMListActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (mUri == null) {
        	Logger.error(getClass(), "Cannot startup activity, null Uri.");
            finish();
            return;
        }
        ...
        try {
        	...
        	Logger.error(getClass(), "Failed to initialize the slide-list.", e);
            finish();
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (Logger.IS_DEBUG_ENABLED) {
            Logger.debug(getClass(), "Saving state: " + mState);
        }
