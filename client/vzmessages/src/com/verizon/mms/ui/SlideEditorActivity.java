...
import com.verizon.mms.model.LayoutModel;
...
import com.verizon.mms.ui.BasicSlideEditorView.OnTextChangedListener;
 ...
 */
public class SlideEditorActivity extends VZMActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
        	...
        	Logger.error(getClass(), "Create SlideshowModel failed!", e);
            finish();
            return;
        }
    }
        ...
        synchronized (this) {
            if (mDirty) {
                try {
                	...
                	Logger.error(getClass(), "Cannot update the message: " + mUri, e);
                }
            }
        }
    }
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_RECORD_SOUND:
            	...
            	int sizeUpTo = MmsConfig.getMaxMessageSize()-1024;
            	
				 if(null!=mSlideshowModel)
				 {
					 sizeUpTo -=  mSlideshowModel.getCurrentMessageSize();
				 }
				 if(sizeUpTo > 0) 
				 {
					 MessageUtils.recordSound(this, REQUEST_CODE_RECORD_SOUND,sizeUpTo);
				 }
				 else
				 {
					 Toast.makeText(this,getString(R.string.exceed_message_size_limitation), Toast.LENGTH_SHORT).show();
				 }
        ...
        switch(requestCode) {
            ...
            case REQUEST_CODE_TAKE_PICTURE:
                ...
                try {
                    ...
                    Logger.error(getClass(), "add image failed", e);
            ...
            case REQUEST_CODE_RECORD_SOUND:
                ...
                try {
                	...
                	Logger.error(getClass(), "add audio failed", e);
            ...
            case REQUEST_CODE_CHANGE_VIDEO:
                try {
                	...
                	Logger.error(getClass(), "add video failed", e);
    ...
    private void notifyUser(String message) {
        if (Logger.IS_DEBUG_ENABLED) {
        	Logger.debug(getClass(), "notifyUser: message=" + message);
        }
    }
