...
public class SlideshowEditor {
    ...
    public static final int MAX_SLIDE_NUM = ComposeMessageFragment.MULTI_ATTACHMENT_MAX_LIMIT;
    ...
    public boolean addNewSlide(int position) {
        ...
        if (size < MAX_SLIDE_NUM) {
            ...
            Logger.warn(getClass(), "The limitation of the number of slides is reached.");
        	}
            return false;
        }
    }
