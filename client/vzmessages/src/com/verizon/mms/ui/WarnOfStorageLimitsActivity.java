...
import com.verizon.internal.app.AlertController;
import com.verizon.messaging.vzmsgs.R;

/**
 * This is the UI for telling the user about the storage limit setting.
 */
public class WarnOfStorageLimitsActivity extends VZMActivity implements DialogInterface,
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // this.setTheme(R.style.Theme_Dialog_Alert);
