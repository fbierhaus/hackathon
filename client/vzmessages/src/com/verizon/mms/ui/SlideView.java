...
public class SlideView extends AbsoluteLayout implements
    ...
    public void setVideo(String name, Uri video) {
        ...
        if (Logger.IS_DEBUG_ENABLED) {
            Logger.debug(getClass(), "Changing video source to " + video);
        }
    ...
    public void setAudio(Uri audio, String name, Map<String, ?> extras) {
        ...
        if (Logger.IS_DEBUG_ENABLED) {
        	Logger.debug(getClass(), "Changing audio source to " + audio);
        }
        ...
        try {
            ...
            mAudioPlayer.setDataSource(getContext(), audio);
    ...
    public void setText(String name, String text) {
        if (!mConformanceMode) {
            if (null == mScrollText) {
                mScrollText = new ScrollView(getContext());
    ...
    public void startVideo() {
        if (mVideoView != null) {
            if (Logger.IS_DEBUG_ENABLED) {
            	Logger.debug(getClass(), "Starting video playback.");
            }
            mVideoView.start();
        }
    }
    ...
    public void stopVideo() {
        if ((mVideoView != null)) {
            if (Logger.IS_DEBUG_ENABLED) {
            	Logger.debug(getClass(), "Stopping video playback.");
            }
    ...
    public void pauseVideo() {
        if (mVideoView != null) {
            if (Logger.IS_DEBUG_ENABLED) {
            	Logger.debug(getClass(), "Pausing video playback.");
            }
            mVideoView.pause();
        }
    }
    ...
    public void seekVideo(int seekTo) {
        if (mVideoView != null) {
            if (seekTo > 0) {
                if (Logger.IS_DEBUG_ENABLED) {
                	Logger.debug(getClass(), "Seeking video playback to " + seekTo);
                }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mSizeChangedListener != null) {
            if (Logger.IS_DEBUG_ENABLED) {
            	Logger.debug(getClass(), "new size=" + w + "x" + h);
            }
    ...
    public void enableMMSConformanceMode(int textLeft, int textTop,
        ...
        if (mScrollViewPort == null) {
            mScrollViewPort = new ScrollView(getContext()) {
            ...
            mViewPort = new LinearLayout(getContext());
