 ...
 * @Since Apr 12, 2012
 */
public class RecentlyUsedListActivity extends VZMListActivity {
    ...
    public void onResume() {
        ...
        if (cursor == null || cursor.getCount() == 0) {
            ...
            Toast.makeText(RecentlyUsedListActivity.this, getString(R.string.no_recentlyused_dlg_msg),
