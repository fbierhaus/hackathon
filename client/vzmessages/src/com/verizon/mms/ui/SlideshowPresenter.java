...
import com.verizon.mms.model.MediaModel.MediaAction;
import com.verizon.mms.model.Model;
import com.verizon.mms.model.RegionMediaModel;
...
import com.verizon.mms.ui.AdaptableSlideViewInterface.OnSizeChangedListener;
...
public class SlideshowPresenter extends Presenter {
    ...
    private final OnSizeChangedListener mViewSizeChangedListener =
        ...
        public void onSizeChanged(int width, int height) {
            ...
            if (Logger.IS_DEBUG_ENABLED) {
            	Logger.debug(getClass(), "ratio_w = " + mWidthTransformRatio
    ...
    protected void presentSlide(SlideViewInterface view, SlideModel model) {
        ...
        try {
            for (MediaModel media : model.getMedia()) {
    ...
    protected void presentRegionMedia(SlideViewInterface view,
        ...
        } else if (rMedia.isVcard()) {
            presentVcard(view, (VCardModel) rMedia, r, dataChanged);
        }
    }
