...
public class PresenterFactory {
    ...
    public static Presenter getPresenter(String className, Context context,
        ...
        try {
            ...
            Logger.error(PresenterFactory.class, "Type not found: " + className, e);
        } catch (NoSuchMethodException e) {
            // Impossible to reach here.
        	Logger.error(PresenterFactory.class, "No such constructor.", e);
        } catch (InvocationTargetException e) {
        	Logger.error(PresenterFactory.class, "Unexpected InvocationTargetException", e);
        } catch (IllegalAccessException e) {
        	Logger.error(PresenterFactory.class, "Unexpected IllegalAccessException", e);
        } catch (InstantiationException e) {
        	Logger.error(PresenterFactory.class, "Unexpected InstantiationException", e);
        }
