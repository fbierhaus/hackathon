...
package com.verizon.mms.dom.smil.parser;
...
public class SmilContentHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) {
            if (Logger.IS_DEBUG_ENABLED) {
                //Logger.debug(getClass(), "SmilContentHandler.startElement. Creating element " + localName);
            }
        Element element = mSmilDocument.createElement(localName);
        if (attributes != null) {
            for (int i = 0; i < attributes.getLength(); i++) {
                    if (Logger.IS_DEBUG_ENABLED) {
                        //Logger.debug(getClass(), "Attribute " + i + " lname = " + attributes.getLocalName(i)
            ...
            if (Logger.IS_DEBUG_ENABLED) {
                //Logger.debug(getClass(), "Appending " + localName + " to " + mCurrentNode.getNodeName());
            }
    ...
    public void endElement(String uri, String localName, String qName) {
            if (Logger.IS_DEBUG_ENABLED) {
                //Logger.debug(getClass(), "SmilContentHandler.endElement. localName " + localName);
            }
    ...
    public void characters(char[] ch, int start, int length) {
            if (Logger.IS_DEBUG_ENABLED) {
                //Logger.debug(getClass(), "SmilContentHandler.characters. ch = "
