...
public class SmilRegionElementImpl extends SmilElementImpl implements SMILRegionElement {
        ...
        try {
            return parseRegionLength(getAttribute(LEFT_ATTRIBUTE_NAME), true);
                ...
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Left attribute is not set or incorrect.");
                }
        }
        try {
            ...
            return bbw - right - width;
                ...
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Right or width attribute is not set or incorrect.");
                }
        }
        return 0;
    }
    ...
    public int getTop() {
        try {
            return parseRegionLength(getAttribute(TOP_ATTRIBUTE_NAME), false);
                ...
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Top attribute is not set or incorrect.");
                }
        }
        try {
            ...
            return bbh - bottom - height;
                ...
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Bottom or height attribute is not set or incorrect.");
                }
        }
        return 0;
    }
    ...
    public int getHeight() {
        try {
            ...
            return height == 0 ? ((SMILDocument) getOwnerDocument()).getLayout().getRootLayout().getHeight()
                    : height;
        } catch (NumberFormatException _) {
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Height attribute is not set or incorrect.");
                }
        }
        int bbh = ((SMILDocument) getOwnerDocument()).getLayout().getRootLayout().getHeight();
        try {
        ...
        try {
            bbh -= parseRegionLength(getAttribute(BOTTOM_ATTRIBUTE_NAME), false);
                ...
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Bottom attribute is not set or incorrect.");
                }
        }
        return bbh;
    }
    ...
    public int getWidth() {
        try {
            ...
            return width == 0 ? ((SMILDocument) getOwnerDocument()).getLayout().getRootLayout().getWidth()
                    : width;
        } catch (NumberFormatException _) {
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Width attribute is not set or incorrect.");
                }
        }
        int bbw = ((SMILDocument) getOwnerDocument()).getLayout().getRootLayout().getWidth();
        try {
        ...
        try {
            bbw -= parseRegionLength(getAttribute(RIGHT_ATTRIBUTE_NAME), true);
                ...
                if (Logger.IS_DEBUG_ENABLED) {
                    Logger.debug(getClass(), "Right attribute is not set or incorrect.");
                }
        }
        return bbw;
    }
    ...
    public String toString() {
        return super.toString() + ": id=" + getId() + ", width=" + getWidth() + ", height=" + getHeight()
