...
public class ArrayListCursor extends AbstractCursor
{
    ...
    public ArrayListCursor(String[] columnNames, ArrayList<ArrayList<Object>> rows)
    {
  ...
  //Not supported in current @Override
    ...
    /*
     * Additional non-cursor method.
     */
    public Object getObject(int columnIndex)
    {
    	return mRows[mPos].get(columnIndex);
    }
}
