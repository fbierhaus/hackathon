echo "Maven Thirdpart JAR deployer"
confirm()
{
...
confirm
mvn install:install-file -DgroupId=com.vzw.navigation -DartifactId=nbi -Dversion=1.2.16   -Dpackaging=jar -Dfile="libs\nbi.jar"
confirm
...
mvn install:install-file -DgroupId=acra -DartifactId=acra -Dversion=4.4.0           -Dpackaging=jar -Dfile="libs\acra-4.4.0.jar"